        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SuperCategories_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RunningTime = table.Column<bool>(type: "bit", nullable: false),
                    RemainingTime = table.Column<bool>(type: "bit", nullable: false),
                    PersonId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Activities_UserId_Tag_Description_Date",
                table: "Activities",
                columns: new[] { "UserId", "Tag", "Description", "Date" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_SuperCategoryId_Name",
                table: "Categories",
                columns: new[] { "SuperCategoryId", "Name" },
                unique: true,
                filter: "[SuperCategoryId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_PersonId_Description_Date",
                table: "Events",
                columns: new[] { "PersonId", "Description", "Date" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_People_UserId_FirstName_LastName",
                table: "People",
                columns: new[] { "UserId", "FirstName", "LastName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SuperCategories_UserId_Name",
